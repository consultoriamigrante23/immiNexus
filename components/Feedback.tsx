...
// Real client feedbacks — always shown
const REAL_FEEDBACKS: FeedbackItem[] = [
  {
    name: "Louise",
    country: "China",
    service: "Canada",
...
export default function FeedbackSection() {
  ...
  const allFeedbacks = [...REAL_FEEDBACKS, ...dbFeedbacks];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
          {allFeedbacks.map((f, i) => (
            <ScrollReveal key={i} delay={((i % 3) + 1) as 1 | 2 | 3}>
              <div
                className="relative bg-white rounded-2xl p-6 border h-full transition-all duration-300"
                ...
                <p className="font-body text-sm leading-relaxed mb-5 italic"
        ...
        <ScrollReveal>
          <div className="rounded-2xl p-8 mb-12 text-center"
            ...
            <p className="font-body text-base mb-6" style={{ color:"var(--text-soft)" }}>
              Join hundreds of satisfied clients. Book your free consultation today.
            </p>
          ...
          <div className="max-w-xl mx-auto">
            {!showForm ? (
              ...
              <div className="bg-white rounded-2xl p-8 border" style={{ borderColor:"rgba(17,153,158,0.1)", boxShadow:"var(--shadow-md)" }}>
                ...
                {error && (
                  <div className="bg-red-50 border border-red-200 text-red-700 text-sm font-body px-4 py-3 rounded-xl mb-4">{error}</div>
                )}
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-body font-semibold tracking-wide uppercase mb-2" style={{ color:"var(--text-soft)" }}>
                      {t("ratingLabel")}
                    </label>
                  ...
                  <div>
                    <textarea {...register("message", { required:true, minLength:10 })}
                      placeholder={t("messagePlaceholder")} rows={4} className="inp" style={{ resize:"none" }}/>
