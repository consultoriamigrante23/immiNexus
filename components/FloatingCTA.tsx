    ...
    <>
      ...
      {visible && (
        <button
          ...
          className="fixed bottom-24 right-6 z-50 w-10 h-10 rounded-full glass border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:border-teal-500/40 transition-all duration-200"
