        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-gray-700">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image src="/logo.png" alt="ImmiNexus" width={40} height={40} className="object-contain" />
              <div>
                <div className="font-heading text-lg font-bold leading-none">ImmiNexus</div>
                <div className="text-brand-400 text-[10px] tracking-widest uppercase font-body">
                  {t("tagline")}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <a href={LINKEDIN} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                className="w-9 h-9 rounded-full bg-gray-800 hover:bg-blue-700 flex items-center justify-center transition-colors">
