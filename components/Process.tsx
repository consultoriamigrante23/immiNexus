...
// Step 3 (index 2) changed from #16c6cc (too light) to #064e50 (dark)
const stepColors = ["#11999e", "#0d7a7e", "#064e50", "#293533"];

const stepIcons = [
  <svg key="1" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
  </svg>,
  <svg key="2" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
    <polyline points="14 2 14 8 20 8"/>
    <line x1="16" y1="13" x2="8" y2="13"/>
    <line x1="16" y1="17" x2="8" y2="17"/>
  </svg>,
  <svg key="3" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <line x1="22" y1="2" x2="11" y2="13"/>
    <polygon points="22 2 15 22 11 13 2 9 22 2"/>
  </svg>,
  <svg key="4" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    <section id="process" className="py-28 bg-gray-50 section-frame">
      <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="flex flex-col items-center text-center cursor-pointer group"
                ...
                <div className="relative mb-6">
                  <div className="w-24 h-24 rounded-full flex items-center justify-center relative z-10"
                    style={{
                      background:  active === i
                        ? `linear-gradient(135deg, ${stepColors[i]}, ${stepColors[i]}cc)`
                        : "white",
        ...
        <ScrollReveal className="text-center mt-14">
          <a href="#contact" className="btn-brand btn-shimmer text-base px-10 py-4">
            {t("cta")}
          </a>
        </ScrollReveal>
      </div>
